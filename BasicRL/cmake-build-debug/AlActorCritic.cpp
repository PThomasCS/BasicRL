...
void AlActorCritic::train(const Eigen::VectorXd& observation, const int curAction, const double reward, const Eigen::VectorXd& newObservation, const int newAction, std::mt19937_64& generator)
{
    // Compute the TD-error
